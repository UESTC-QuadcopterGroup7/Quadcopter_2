...
void  OSInitHookBegin (void)
{
    ...
    OS_CPU_ExceptStkBase = (OS_STK *)&OS_CPU_ExceptStk[256u];
    ...
    OS_KA_BASEPRI_Boundary = (INT32U)(1u << (8u - 4u));
}
                        ...
                        INT16U    opt)
{
    ...
    *(--p_stk) = (OS_STK)0x03030303uL;                           
    *(--p_stk) = (OS_STK)0x02020202uL;                           
    *(--p_stk) = (OS_STK)0x01010101uL;                           
    *(--p_stk) = (OS_STK)p_arg;                                  
    ...
    *(--p_stk) = (OS_STK)0x10101010uL;                           
    *(--p_stk) = (OS_STK)0x09090909uL;                           
    *(--p_stk) = (OS_STK)0x08080808uL;                           
    *(--p_stk) = (OS_STK)0x07070707uL;                           
    *(--p_stk) = (OS_STK)0x06060606uL;                           
...
void  OS_CPU_SysTickInit (INT32U  cnts)
{
    ...
    basepri               = (INT32U)(1u << (8u - 4u));
    (*((volatile INT32U *)0xE000E014uL))    = cnts - 1u;                           

                                                                 
    prio                  =  (*((volatile INT32U *)0xE000ED20uL));
    prio                 &=  0x00FFFFFFu;
    prio                 |= (basepri << 24u);
    (*((volatile INT32U *)0xE000ED20uL))  = prio;

                                                                 
    (*((volatile INT32U *)0xE000E010uL))   |= 0x00000004uL |
                            0x00000001uL;
                                                                 
    (*((volatile INT32U *)0xE000E010uL))   |= 0x00000002uL;
}
