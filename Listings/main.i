...
static OS_STK AppTaskStartStk[256u];
static OS_STK AppTaskSensorStk[512u];
static OS_STK AppTaskDebugStk[256u];
...
static void AppTaskStart(void *p_arg)
{
    ...
    OSTaskCreate(AppTaskSensor,
                 (void *)0,
                 &AppTaskSensorStk[512u - 1],
                 6u);

    OSTaskCreate(AppTaskDebug,
                 (void *)0,
                 &AppTaskDebugStk[256u - 1],
                 10u);
