...
#line 41 "ucCPU\\cpu_c.c"

#line 43 "ucCPU\\cpu_c.c"
...
void  CPU_IntSrcDis (CPU_INT08U  pos)
{
    ...
    switch (pos) {
        ...
        default:
             pos_max = (((((*((CPU_REG32 *)(0xE000E004))) & 0xF) + 1) * 32) + 16);
             if (pos < pos_max) {                                
                 group = (pos - 16) / 32;
                 nbr   = (pos - 16) % 32;

                 do { do { cpu_sr = CPU_SR_Save(1u << (8u - 4u));} while (0); } while (0);
                 (*((CPU_REG32 *)(0xE000E180 + (group) * 4u))) = (1uL << (nbr));        
                 do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
             }
             break;
    }
    ...
    switch (pos) {
        ...
        default:
             ...
             if (pos < pos_max) {                                
                 ...
                 do { do { cpu_sr = CPU_SR_Save(1u << (8u - 4u));} while (0); } while (0);
                 (*((CPU_REG32 *)(0xE000E100 + (group) * 4u))) = (1uL << (nbr));        
                 do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
             }
             break;
    }
    ...
    switch (pos) {
        ...
        default:
             ...
             if (pos < pos_max) {                                
                 ...
                 do { do { cpu_sr = CPU_SR_Save(1u << (8u - 4u));} while (0); } while (0);
                 (*((CPU_REG32 *)(0xE000E280 + (group) * 4u))) = (1uL << (nbr));        
                 do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
             }
             break;
    }
                         ...
                         CPU_INT08U  type)
{
    ...
    switch (pos) {
        ...
        case 4u:                                        
             ...
             temp                &= ~((CPU_INT32U)0xFFu << (0 * 8u));
             temp                |=  ((CPU_INT32U)prio_offset    << (0 * 8u));
        ...
        case 5u:                                   
             do { do { cpu_sr = CPU_SR_Save(1u << (8u - 4u));} while (0); } while (0);
             temp                 = (*((CPU_REG32 *)(0xE000ED18)));
             temp                &= ~((CPU_INT32U)0xFFu << (1 * 8u));
             temp                |=  ((CPU_INT32U)prio_offset    << (1 * 8u));
             (*((CPU_REG32 *)(0xE000ED18)))   = temp;
             do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
             break;
        ...
        case 6u:                                 
             do { do { cpu_sr = CPU_SR_Save(1u << (8u - 4u));} while (0); } while (0);
             temp                 = (*((CPU_REG32 *)(0xE000ED18)));
             temp                &= ~((CPU_INT32U)0xFFu << (2 * 8u));
             temp                |=  ((CPU_INT32U)prio_offset    << (2 * 8u));
             (*((CPU_REG32 *)(0xE000ED18)))   = temp;
             do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
             break;
        ...
        case 11u:                                     
             ...
             temp                |=  ((CPU_INT32U)prio_offset    << (3 * 8u));
        ...
        default:
             ...
             if (pos < pos_max) {                                
                 ...
                 temp                    &= ~((CPU_INT32U)0xFFu << (nbr * 8u));
                 temp                    |=  ((CPU_INT32U)prio_offset    << (nbr * 8u));
