...
#define  CPU_CFG_NVIC_PRIO_BITS    4u    /* STM32 uses 4 bits for Interrupt Priority */
#define  CPU_CFG_KA_IPL_BOUNDARY   4u    /* Kernel Aware Interrupt Priority Level Boundary */
